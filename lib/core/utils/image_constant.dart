class ImageConstant {
  ...
  // 2 login images
  static String imgX1 = '$imagePath/img_x_1.png';

  // 3 SignUp images
  static String imgVuesaxLinearArrowLeft =
      '$imagePath/img_vuesax_linear_arrow_left.svg';
  ...
  static String imgVecteezyCuteR165x145 =
      '$imagePath/img_vecteezy_cute_r_165x145.png';
  ...
  static String imgRightArrow = '$imagePath/img_right_arrow.png';

  static String imgGrid = '$imagePath/img_grid.svg';

  static String imgEarthGlobe = '$imagePath/img_earth_globe.png';
